...
puts "Creanting spots..."
  ...
  parking = Spot.create(name: "Parking des Halles", location: "Parvis Renée Richard, 69003 Lyon", category:'Archi', description: "Un de mes endroits préférés pour faire des photos! La vue est folle et les bâtiments autour.")
